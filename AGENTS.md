...
This file is the single source of truth for project-specific agent guidance:
guidelines, coding standards, architecture, workflows, test/build commands,
and style. Follow sandbox and tool constraints from the active environment,
but defer to this file for all project-specific behavior.

If a change requires updating project rules, conventions, commands, or
style guidelines, update this file.
...
src/
  ...
  domain/
    ...
    status_event.rs    # StatusEvent, StatusEventFeed
